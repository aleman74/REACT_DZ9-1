...
import {BrowserRouter, Link, NavLink, Route, Routes, Router} from "react-router-dom";
import './App.css';
...
function Menu() {
  ...
  return (
      <nav className="menu">
          ...
          <NavLink className="menu__item" end to="/">Главная</NavLink>
          <NavLink className="menu__item" end to="/drift">Дрифт-такси</NavLink>
          <NavLink className="menu__item" end to="/timeattack">Time Attack</NavLink>
          <NavLink className="menu__item" end to="/forza">Forza Karting</NavLink>
